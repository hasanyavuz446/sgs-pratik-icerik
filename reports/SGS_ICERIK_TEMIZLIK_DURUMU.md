...
**16 ders · 107 konu · 6420 soru.** Tamamlanan: **59 / 107 konu = %55,1**
...
| 7 | ticaret_hukuku | 7 | 4 | 🔵 **ticaret_sirketleri** (97→158 · olumsuz %5→**%42** · kalıp 37/60→**0/60**) · **ticari_isletme_tacir** (112→172 · %8→**%37**) · **kiymetli_evrak** (92→148 · %3→**%35** · boy 20/20→8/6) · **kambiyo_senetleri** (78→**122** · %0→**%38** · kör %23→**%21** · **ters boy tuzağı 9/22→21/8**). ⚠️ Sahiplik devri: 4 builder / 23 kayıt. **Boru hattı otomatikleşti** (`yapisal_pipeline.py` + `sahiplik_devri.py`). 3 konu kaldı |
