...
**16 ders · 107 konu · 6420 soru.** Tamamlanan: **56 / 107 konu = %52,3**
...
| 7 | ticaret_hukuku | 7 | 1 | 🔵 **ticaret_sirketleri YAPISAL kalibrasyon (60/60)** — medyan 97→**158** · olumsuz %5→**%42** (bant 41) · **aynı kök kalıbı 37/60→0/60** · öncüllü %8→%13 · kör %25 · düzey 2:32/3:15. Sahiplik devri gerekmedi (yalnız fix_lexical_tell paket düzeyinde). 6 konu kaldı |
