...
q("Aşağıdakilerden hangileri TMS 23'e göre özellikli varlık tanımını karşılar?\n\nI. İnşası zorunlu olarak iki yıl süren baraj\n\nII. İki ayda fermantasyonu tamamlanan turşular\n\nIII. Kullanıma hazır satın alınan standart makine",
  "Yalnız I",
  ["I, II ve III", "I ve III", "I ve II", "Yalnız III"],
  "Özellikli varlığın amaçlanan kullanıma veya satışa hazır duruma getirilmesi zorunlu olarak önemli bir süre gerektirir. Baraj (I) bu ölçütü karşılar; kısa sürede üretilen stok (II) ile kullanıma hazır makine (III) karşılamaz. Yalnız I doğrudur.",
