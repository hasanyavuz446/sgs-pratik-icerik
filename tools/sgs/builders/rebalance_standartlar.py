...
TMS38_KISALT = {
    "std-tms38-gen-0015": {"A": "Varlık olarak kaydedilir"},
    "std-tms38-gen-0016": {"A": "Aktifleştirilir"},
    "std-tms38-gen-0011": {"A": "Geliştirme maliyetidir"},
    "std-tms38-gen-0012": {"B": "Aktifleştirilir"},
    "std-tms38-gen-0025": {"A": "Geliştirme faaliyetidir"},
    "std-tms38-gen-0026": {"A": "Araştırma faaliyetidir"},
    "std-tms38-gen-0040": {"B": "İtfa yapılmaz"},
    "std-tms38-gen-0052": {"A": "TMS 2 uygulanır"},
...
TMS36_OZEL = {
    ...
    "std-tms36-gen-0003": "Gerçeğe uygun değerden satış maliyetleri ile kullanım değerinin toplamı alınarak bulunan tutardır",
    "std-tms36-gen-0004": "Varlığın piyasada hemen satılması hâlinde elde edilecek net satış fiyatını ifade eden bir ölçüdür",
    "std-tms36-gen-0005": "Nakit yaratan birim, işletmenin nakit girişi sağlayan en büyük varlık grubu olan işletmenin tamamıdır",
    "std-tms36-gen-0006": "İşletme değer düşüklüğü belirtilerini yalnızca varlık satıldığında değerlendirir; dönem sonlarında değerlendirme yapmaz",
    "std-tms36-gen-0007": "Sınırlı ömürlü tüm maddi duran varlıklar için belirti olmasa dahi yıllık değer düşüklüğü testi her hâlde zorunludur",
    "std-tms36-gen-0010": "Geri kazanılabilir tutar her hâlde iki ölçünün de ayrı ayrı hesaplanmasını gerektirir; birinin defter değerini aşması yeterli değildir",
    "std-tms36-gen-0011": "Maliyet modelindeki bir varlığın değer düşüklüğü zararı doğrudan diğer kapsamlı gelirde muhasebeleştirilir",
    "std-tms36-gen-0012": "Yeniden değerlenmiş bir varlıkta değer düşüklüğü zararı her hâlde doğrudan kâr veya zarara yansıtılır",
    "std-tms36-gen-0018": "Kullanım değeri yalnızca varlığın geçmiş dönemlerde sağladığı fiili nakit akışlarına dayanılarak hesaplanır",
    "std-tms36-gen-0019": "Kullanım değeri hesabında işletmenin ağırlıklı ortalama borçlanma maliyeti vergi sonrası oran olarak kullanılır",
    "std-tms36-gen-0020": "Nakit akışı tahminleri, henüz taahhüt edilmemiş gelecekteki yeniden yapılandırma ve iyileştirmelerin etkilerini de içerir",
    "std-tms36-gen-0021": "Kullanım değeri hesabına finansman faaliyetlerinden nakit akışları ile gelir vergisi tahsilatları da dâhil edilir",
    "std-tms36-gen-0022": "Değer düşüklüğünden sonra düzeltilmiş defter değeri üzerinden amortisman ayrılmaz; varlık o tutarda sabit tutulur",
    "std-tms36-gen-0024": "Bireysel bir varlığın geri kazanılabilir tutarı belirlenemiyorsa değer düşüklüğü testi hiç yapılmaz",
    "std-tms36-gen-0025": "Nakit yaratan birimdeki değer düşüklüğü zararı önce diğer varlıklara, en son varsa şerefiyeye dağıtılır",
    "std-tms36-gen-0026": "Nakit yaratan birimdeki bir varlığın defter değeri gerçeğe uygun değerinin altına indirilebilir ve negatif tutara ulaşabilir",
    "std-tms36-gen-0028": "İşletme birleşmesinde edinilen şerefiye itfaya tabi tutulur; ayrıca değer düşüklüğü testine gerek yoktur",
    "std-tms36-gen-0031": "Değer düşüklüğü zararı hiçbir koşulda iptal edilemez; ilk muhasebeleştirilen zarar kalıcı niteliktedir",
    "std-tms36-gen-0032": "Şerefiyeye ilişkin değer düşüklüğü zararı, koşullar iyileşirse izleyen dönemlerde iptal edilebilir",
    "std-tms36-gen-0033": "Değer düşüklüğü iptalinde üst sınır yoktur; varlık gerçeğe uygun değerine kadar sınırsız biçimde artırılabilir",
    "std-tms36-gen-0034": "Maliyet modelindeki bir varlığın değer düşüklüğü iptali doğrudan özkaynağa değer artış fonu olarak kaydedilir",
    "std-tms36-gen-0036": "Değer düşüklüğü iptalinden sonra amortisman, varlığın ilk maliyeti üzerinden yeniden hesaplanarak ayrılır",
    "std-tms36-gen-0037": "Nakit yaratan birimdeki iptal, şerefiye dâhil tüm varlıklara defter değerleriyle orantılı biçimde dağıtılır",
    "std-tms36-gen-0038": "Değer düşüklüğü iptali belirtileri yalnızca varlığın fiziki durumundaki iyileşmeyi kapsar; piyasa ve çevre koşulları dışlanır",
    "std-tms36-gen-0040": "Şerefiyeye ilişkin değer düşüklüğü zararı, sonraki dönemlerde koşullar düzelirse tam olarak iptal edilir",
    "std-tms36-gen-0044": "Stoklar, ertelenmiş vergi varlıkları ve finansal varlıklar da TMS 36 kapsamında değer düşüklüğü testine tabidir",
    "std-tms36-gen-0045": "Sınırsız ömürlü bir marka için değer düşüklüğü testi yalnızca değer düşüklüğü belirtisi bulunduğunda yapılır",
    "std-tms36-gen-0047": "Gerçeğe uygun değerden satış maliyetleri düşülmüş tutar, varlığın işletmeye özgü kullanım değerini ifade eder",
    "std-tms36-gen-0048": "Satış maliyetlerine finansman maliyetleri ile gelir vergisi gideri de dâhil edilerek hesaplama yapılır",
    "std-tms36-gen-0049": "Kullanım değeri hesabında nakit akışı projeksiyonları en fazla on beş yıllık bütçe veya tahminlere dayandırılır",
    "std-tms36-gen-0050": "Beş yılı aşan dönemler için her hâlde artan bir büyüme oranı kullanılarak nakit akışları tahmin edilir",
    "std-tms36-gen-0051": "Ortak varlıklar, tek bir nakit yaratan birime ait olan ve bağımsız nakit akışı üreten varlıklardır",
    "std-tms36-gen-0052": "Ortak varlıklar hiçbir nakit yaratan birime dağıtılmaz; her biri ayrı ayrı test edilerek ölçülür",
    "std-tms36-gen-0053": "Sınırsız ömürlü maddi olmayan duran varlığın yıllık testi her hâlde raporlama dönemi sonunda yapılır",
    "std-tms36-gen-0054": "Şerefiyenin dağıtıldığı nakit yaratan birim, işletmenin faaliyet bölümlerinden daha büyük olamaz ve en üst düzeyde izlenir",
    "std-tms36-gen-0055": "Şerefiye dağıtılmış nakit yaratan birim yalnızca değer düşüklüğü belirtisi bulunduğunda test edilir",
    "std-tms36-gen-0056": "Aynı varlık için nakit yaratan birimler her dönem işletmenin tercihine göre serbestçe değiştirilebilir",
    "std-tms36-gen-0057": "Nakit yaratan birimin defter değeri, geri kazanılabilir tutarın belirlenme biçiminden bağımsız olarak hesaplanır",
}

# ── TMS 38 · Maddi Olmayan Duran Varlıklar ────────────────────────────────────
TMS38_OZEL = {
    "std-tms38-gen-0001": "Fiziksel niteliği bulunan, kısa sürede tüketilen ve stok niteliğindeki varlıkları ifade eden bir kavramdır",
    "std-tms38-gen-0002": "Tanımın tek unsuru varlığın fiziksel bir kaleme bağlı olmasıdır; tanımlanabilirlik ve kontrol koşulları aranmaz",
    "std-tms38-gen-0003": "Bir varlığın tanımlanabilir sayılması için mutlaka fiziksel olarak elle tutulabilir ve ayrılabilir olması gerekir",
    "std-tms38-gen-0004": "Kontrol, varlığın hukuki mülkiyetine sahip olmayı gerektirir; yasal bir hak bulunmadan kontrolden söz edilemez",
    "std-tms38-gen-0005": "Nitelikli personelden oluşan ekip, işletmenin kontrolündeki bir maddi olmayan duran varlık olarak muhasebeleştirilir",
    "std-tms38-gen-0007": "Gerçeğe uygun değeriyle ölçülür; edinimle ilgili işlem maliyetleri doğrudan gider olarak yazılır",
    "std-tms38-gen-0008": "İşletme birleşmesinde edinilen maddi olmayan duran varlık, satın alan işletmenin kayıtlı defter değeriyle ölçülür",
    "std-tms38-gen-0009": "Devlet teşvikiyle bedelsiz edinilen maddi olmayan duran varlık her hâlde sıfır değerle kayıtlara alınır",
    "std-tms38-gen-0010": "Maliyete yalnızca alış fiyatı girer; varlığı amaçlanan kullanıma hazırlamak için katlanılan doğrudan harcamalar hariç tutulur",
    "std-tms38-gen-0015": "İşletme içinde yaratılan şerefiye, güvenilir biçimde ölçülebiliyorsa maddi olmayan duran varlık olarak muhasebeleştirilir",
    "std-tms38-gen-0017": "Araştırma aşamasındaki harcamalar her hâlde aktifleştirilir ve maddi olmayan duran varlığın maliyetine eklenir",
    "std-tms38-gen-0018": "Geliştirme aşamasındaki harcamalar koşullara bakılmaksızın her hâlde doğrudan dönem gideri olarak yazılır",
    "std-tms38-gen-0020": "Daha önce gider olarak yazılmış bir harcama, sonradan koşullar sağlanırsa varlığın maliyetine geri eklenebilir",
    "std-tms38-gen-0021": "Araştırma ve geliştirme safhaları ayrılamıyorsa harcamaların tamamı geliştirme safhasında yapılmış sayılır ve aktifleştirilir",
    "std-tms38-gen-0024": "İçsel yaratılan maddi olmayan duran varlığın maliyeti, projenin başlangıcından itibaren yapılan tüm harcamaları içerir",
    "std-tms38-gen-0030": "İşletme, maddi olmayan duran varlıkların faydalı ömrünü her hâlde sınırlı kabul eder; sınırsız ömür söz konusu olamaz",
    "std-tms38-gen-0032": "Sınırsız faydalı ömür, varlığın ömrünün sonsuz olduğu ve hiçbir zaman değer kaybetmeyeceği anlamına gelir",
    "std-tms38-gen-0033": "Sınırsız ömür değerlendirmesi ilk kayıttan sonra bir daha gözden geçirilmez; başlangıçtaki karar kalıcıdır",
    "std-tms38-gen-0034": "Sınırlı faydalı ömürlü maddi olmayan duran varlık itfaya tabi tutulmaz; yalnızca değer düşüklüğü testine tabidir",
    "std-tms38-gen-0035": "İtfaya, varlığın edinildiği tarihte başlanır; varlığın kullanıma hazır olup olmaması dikkate alınmaz",
    "std-tms38-gen-0036": "Maddi olmayan duran varlığın kalıntı değeri her hâlde sıfır kabul edilir; hiçbir koşulda başka bir tutar belirlenemez",
    "std-tms38-gen-0037": "İtfa süresi ve itfa yöntemi hiçbir zaman gözden geçirilmez; ilk belirlenen esaslar ömür boyunca sabit kalır",
    "std-tms38-gen-0038": "Hasılata dayalı itfa yöntemi maddi olmayan duran varlıklar için her hâlde en uygun ve önerilen yöntemdir",
    "std-tms38-gen-0039": "Yalnızca doğrusal itfa yöntemi kullanılabilir; azalan bakiyeler ve üretim birimi yöntemleri kabul edilmez",
    "std-tms38-gen-0040": "Ekonomik yararların tüketim biçimi güvenilir belirlenemiyorsa itfa hiç yapılmaz; varlık maliyet bedeliyle sabit tutulur",
    "std-tms38-gen-0046": "Maddi olmayan duran varlıklar her hâlde yeniden değerleme modeliyle ölçülür; maliyet modeli kullanılamaz",
    "std-tms38-gen-0047": "Yeniden değerleme modeli, aktif bir piyasa bulunmasa dahi her maddi olmayan duran varlığa uygulanabilir",
    "std-tms38-gen-0048": "Maliyet modelinde varlık, gerçeğe uygun değeriyle ölçülür ve değer artışları doğrudan özkaynağa yansıtılır",
    "std-tms38-gen-0049": "Maddi olmayan duran varlık yalnızca fiziksel olarak yok olduğunda finansal tablo dışı bırakılır",
    "std-tms38-gen-0053": "Henüz kullanıma hazır olmayan maddi olmayan duran varlık itfaya tabi tutulur; değer düşüklüğü testi yapılmaz",
    "std-tms38-gen-0060": "Maddi olmayan duran varlık sınıfı, işletmenin sahip olduğu tüm maddi olmayan varlıkları tek bir grupta toplar",
}
