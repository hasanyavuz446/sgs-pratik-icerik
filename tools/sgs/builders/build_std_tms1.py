...
q("Aşağıdaki ifadelerden hangileri TMS 1 bakımından doğrudur?\n\nI. Tam set en az yıllık sunulur\n\nII. Tam setin ayda bir sunulması zorunludur\n\nIII. Dipnotlar tam setin parçası değildir",
  "Yalnız I",
  ["I, II ve III", "I ve II", "II ve III", "Yalnız III"],
  "Tam set en az yıllık sunulur (I). TMS 1 aylık sunum zorunluluğu getirmez (II) ve dipnotlar tam setin ayrılmaz parçasıdır (III). Bu nedenle yalnız I doğrudur.",
