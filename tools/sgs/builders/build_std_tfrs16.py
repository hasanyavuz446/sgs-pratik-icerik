...
q("Aşağıdakilerden hangileri TFRS 16'ya göre kiracının muafiyet uygulayabileceği kiralamalardandır?\n\nI. Kısa vadeli kiralamalar\n\nII. Dayanak varlığın düşük değerli olduğu kiralamalar\n\nIII. Kiracının kârsız olduğu dönemdeki kiralamalar",
  "I ve II",
  ["I, II ve III", "Yalnız I", "II ve III", "Yalnız III"],
  "TFRS 16 iki muafiyet öngörür: kısa vadeli kiralamalar (I) ve dayanak varlığın düşük değerli olduğu kiralamalar (II). Kiracının kârlılık durumu (III) TFRS 16'da bir muafiyet ölçütü değildir.",
  "TFRS 16 - muafiyetler")
